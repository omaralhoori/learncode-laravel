	...
	<div class="famous-courses">
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="course">
					@if($course->photo)
					<a href="/courses/{{$course->slug}}"><img src="/storage/courseImgs/{{ $course->photo->filename }}"></a>
					@else
					<a href="/courses/{{$course->slug}}"><img src="/imgs/course_no_photo.jpg"></a>
					@endif
							...
							<div class="row">
								<div class="col-sm-2">
									<div class="course-image">
										...
										@else
										<img src="/imgs/course_no_photo.jpg">
										@endif
									</div>
								</div>
								<div class="col-sm">
