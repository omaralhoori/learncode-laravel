...
$factory->define(User::class, function (Faker $faker) {
    return [
        ...
        'score' => $faker->randomElement([55, 90, 200, 100]),
    ];
});
...
$factory->define(\App\Course::class, function (Faker $faker) {
    ...
    return [
        ...
        'link' => $faker->url,
        'track_id' => \App\Track::all()->random()->id,
    ];
});
